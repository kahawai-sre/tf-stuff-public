...
$env:ARM_MSI_ENDPOINT    ??= $env:IDENTITY_ENDPOINT
...
Write-Verbose "ARM_USE_MSI:" $env:ARM_USE_MSI
Write-Verbose "ARM_MSI_ENDPOINT:" $env:ARM_MSI_ENDPOINT
Write-Verbose "ARM_TENANT_ID:" $env:ARM_TENANT_ID
Write-Verbose "ARM_SUBSCRIPTION_ID:" $env:ARM_SUBSCRIPTION_ID
Write-Verbose "ARM_CLIENT_ID:" $env:ARM_CLIENT_ID
Write-Verbose "ARM_USE_MSI:" $env:ARM_USE_MSI
Write-Verbose "ARM_OIDC_TOKEN:" $env:ARM_OIDC_TOKEN

# if ($env:ARM_CLIENT_SECRET) {
#     Write-Verbose "Using ARM_CLIENT_SECRET"
# } elseif ($env:ARM_OIDC_TOKEN) {
#     Write-Verbose "Using ARM_OIDC_TOKEN or MSI"
# } else {
